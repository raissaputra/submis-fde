...
class DatabaseHelper {
  ...
  static const String _tblWatchlistTvSeries = 'watchlist_tv';
  ...
  Future<int> insertWatchlistTvSeries(Map<String, dynamic> tvSeries) async {
    final db = await database;
    return await db!.insert(_tblWatchlistTvSeries, tvSeries);
  }

  Future<int> removeWatchlistTvSeries(Map<String, dynamic> tvSeries) async {
    final db = await database;
    return await db!.delete(
