  ...
  void initState() {
    ...
    Future.microtask(() {
      context
          ...
          .add(OnNowPlayingTvSeriesRequested());
      context.read<PopularTvSeriesBloc>().add(OnPopularTvSeriesRequested());
      context.read<TopRatedTvSeriesBloc>().add(OnTopRatedTvSeriesRequested());
    });
  }
